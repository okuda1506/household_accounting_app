        ...
        <main className="max-w-5xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <Card className="bg-black border-gray-800">
                ...
                <div className="flex justify-between items-center text-sm">
                    ...
                    <p className="text-xl font-semibold text-green-400">¥500,000</p>
                    </div>
                    <div>
            ...
            <Card className="bg-black border-gray-800">
                <CardHeader>
                <CardTitle className="text-lg font-medium">最近の取引</CardTitle>
                </CardHeader>
                <CardContent>
                <ul className="space-y-4">
                    {[
                    { date: "6/15", description: "スーパー", amount: -5000 },
                    { date: "6/14", description: "給与", amount: 350000 },
                    { date: "6/13", description: "レストラン", amount: -8000 },
                    { date: "6/12", description: "電気代", amount: -12000 },
